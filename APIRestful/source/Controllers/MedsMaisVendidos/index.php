...
switch ($_SERVER['REQUEST_METHOD']) {
    case "GET":
        ...
        if ($venda->find()->count() > 0) {
            $return = array();
            $sql = "SELECT sum(qtdProduto) as 'somaTotal', v.idMedicamento, m.composicaoMed, m.descMed, m.descDosagem, tp.tipoDosagem, m.precoMed, l.nomeLaboratorio, c.nomeCategoria, e.idEstabelecimento, t.descTarja from tbVenda v
                    ...
                    where v.idEstabelecimento like '$idEstabelecimento' and v.idMedicamento != 0 
                    group by v.idMedicamento
